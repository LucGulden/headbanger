...
export default function SignupPage() {
  ...
  const { signUp, signInWithGoogle, user, loading: authLoading, error: authError } = useAuth();
      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-[var(--background-lighter)] bg-[var(--background-light)] p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button type="submit" loading={loading || checkingUsername} disabled={loading || checkingUsername}>
              Créer mon compte
            </Button>
          </form>
